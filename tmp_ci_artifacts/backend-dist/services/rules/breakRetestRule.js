...
class BreakRetestRule extends base_1.BaseRule {
    async evaluate(context) {
        ...
        if (Math.abs(last.close - prev.close) < break_buffer_ticks)
            return this.createResult(false, 0, 'No breakout');
        ...
        if (retest)
            return this.createResult(true, 0.9, 'Break and retest confirmed');
        return this.createResult(false, 0, 'Break found but no retest');
    }
}
exports.default = BreakRetestRule;
