...
class OrderflowDeltaRule extends base_1.BaseRule {
    async evaluate(context) {
        ...
        const deltaSeries = (marketState.orderflow && marketState.orderflow.cumulativeDelta) || marketState.cumulativeDelta;
        ...
        if (std === 0)
            return this.createResult(false, 0, 'Insufficient delta variance');
...
exports.default = OrderflowDeltaRule;
